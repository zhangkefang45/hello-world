...
if __name__ == '__main__':
    ...
    while i <= 10:
        ...
        dep = rgb.read_depth_data()
        if img is None:
            continue
        if dep is None:
            continue

        cv2.imwrite("/home/ljt/Desktop/ws/src/fetch_moveit_config/images/rgb/"+str(i)+".png", img)
        cv2.imwrite("/home/ljt/Desktop/ws/src/fetch_moveit_config/images/dep/"+str(i)+".png", dep)
        print i
        i=i+1
